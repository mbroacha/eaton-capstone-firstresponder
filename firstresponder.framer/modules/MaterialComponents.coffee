...
# Edited by Morgan Broacha strictly for use in this project.
########################################################################################################
...
# 9. TextField_n (Text fields frankenstiend from Jordan Robert Dobson's InputField)
...
#------ Default properties --------------------------------------------------------------------------------------------
		...
		@options.themeColor ?= "rgba(255, 255, 255, 0)"
...
#------ shadow -----------------------------------------------------------------------------------------------------
		...
		@shadow.umbra.states.switchInstant "_0dp"
		@shadow.penumbra.states.switchInstant "_0dp"
		@shadow.ambient.states.switchInstant "_0dp"
...
#------ event functions ---------------------------------------------------------------------------------------------
	...
	Hover: ->
		@shadow.umbra.states.switch "_2dp"
		@shadow.penumbra.states.switch "_2dp"
		@shadow.ambient.states.switch "_2dp"

	HoverOff: ->
		@shadow.umbra.states.switch "_0dp"
		@shadow.penumbra.states.switch "_0dp"
		@shadow.ambient.states.switch "_0dp"

	mouseDown: ->
		@overlay.visible = true
		@shadow.umbra.states.switchInstant "_2dp"
		@shadow.penumbra.states.switchInstant "_2dp"
		@shadow.ambient.states.switchInstant "_2dp"
